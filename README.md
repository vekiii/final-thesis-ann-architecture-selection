...
- Optimization algorithms: Scaled Conjugate Gradient (SCG) vs. Levenberg–Marquardt (LM)
...
- **Levenberg–Marquardt dominance:** Empirically shown to outperform SCG, reducing test error and increasing model confidence on complex datasets
- **Overfitting rule:** Increasing hidden-layer neurons beyond the optimal value (≈10 in most simulations) leads to performance degradation on the test set
